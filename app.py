...
if seleccionadas:
    ...
    # 3. DASHBOARD DE AVANCE DE PRODUCCIÓN
    if not df_reporte.empty:
        ...
        fig_gauge = go.Figure(go.Indicator(
            ...
            gauge = {
                ...
                'bordercolor': "gray",
                'steps': [
                    {'range': [0, 100], 'color': "rgba(255, 235, 238, 0.1)"} 
                ],
                'threshold': {
    ...
    st.info("👆 Selecciona las actividades asignadas en la lista desplegable superior para iniciar la matriz.")
